...
public class Operators {
    public static void main(String[] args) {
        ...
        if ((topScore>70)|| (secondTopScore<=90))
            System.out.println("One of the tests must be true!");
        ...
        if(theRemainder <=20)
            System.out.println("myTotal was over the limit");
    }
}
